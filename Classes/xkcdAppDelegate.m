...
static NSString * const kUserDefaultsRotateKey = @"rotate";
static NSString * const kUserDefaultsOpenZoomedOutKey = @"zoomed_out";
static NSString * const kUserDefaultsAutodownloadKey = @"autodownload";
static NSString * const kUserDefaultsOpenAfterDownloadKey = @"autoopen";
